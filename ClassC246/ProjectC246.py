...
def ethereum_block():
    ...
    gas_price_in_ETH = gwei_price/10**9
    gas_price_in_USD = gas_price_in_ETH*3103.69
    gas_price_in_Rupees = gas_price_in_ETH*231756.67
    gas_price_in_Pounds = gas_price_in_ETH*2268.81
    
    value_in_ether['text'] = 'Value of gas in Ether: ' + str(gas_price_in_ETH) + ' ETH'
    value_in_dollar['text'] = 'Value of gas in USD: $ ' + str(gas_price_in_USD) 
